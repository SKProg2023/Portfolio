...
let leftPos = 10; // variable for coordinates
let lf = "leftpic";
let rt = "righttpic";
let bt = "bottompic";
...
let GametoView = function () {
  ...
  NoteField1.style = `position:fixed; left: 30%; top: 75%;
   height: 25px; size: 25; font-size: 25px; max-width:40%`;
  ...
  for(let i = 1; i < 37; i++) { // creating future placements of user's cards
    ...
    lf.id = "lp"+i;
    lf.style = `position: fixed; left: ${leftPos}%; top: ${topPos}%; transform: translate(-50%, -50%);
    max-width:10%`;
    topPos += 4;
  ...
  for(let i = 1; i < 37; i++) { // creating future placements of computers' cards
    ...
    rt.id = "rp"+i;
    rt.style = `position: fixed; left: ${leftPos}%; top: ${topPos}%; transform: translate(-50%, -50%);
    max-width:10%`
    topPos += 4;
  ...
  for(let i = 1; i < 37; i++) {
    ...
    rtH.id = "rpH"+i;
    rtH.style = `position: fixed; left: ${leftPos}%; top: ${topPos}%; transform: translate(-50%, -50%);
    max-width:10%`
    topPos += 4;
  ...
  for(let i = 1; i < 7; i++) {
    ...
    btUp.style = `position: fixed; left: ${leftPos}%; top: ${topPos}%; transform: translate(-50%, -50%);
    max-width:10%`;
    leftPos += 8;
  ...
  for(let i = 1; i < 7; i++) {
    ...
    btBt.style = `position: fixed; left: ${leftPos}%; top: ${topPos}%; transform: translate(-50%, -50%);
    max-width:10%`;
    leftPos += 8;
...
let deal = async function() {
  ...
  showTrumpCard.id = "TC";
  showTrumpCard.style = `position: fixed; left: 43%; top: 38%; transform: translate(-50%, -50%);
  border: solid; max-width:10%`;
  document.body.appendChild(showTrumpCard);
  document.getElementById("mD").style =`position: fixed; left: 39%; top: 21%;
  border: solid; transform: rotate(90deg); max-width:10%`; //repositioning image of main deck
  document.body.appendChild(mainDeck);
  ...
  PassPic.id = `PP`;
  PassPic.style = `position: fixed; left: 60%; top: 32%; transform: translate(-50%, -50%);
  border-style: inset; border: solid; max-width:10%`;
  ...
  TakePic.id = `TP`;
  TakePic.style = `position: fixed; left: 60%; top: 42%; transform: translate(-50%, -50%);
  border-style: inset; border: solid; max-width:10%`;
