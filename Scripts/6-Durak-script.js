...
let topPos = 200; // variable for coordinates
let leftPos = 20; // variable for coordinates
let lf = "leftpic";
let rt = "righttpic";
let bt = "bottompic";
...
let GametoView = function () {
  ...
  NoteField1.style = `position:absolute; left: 350px; top: 450px;
   height: 35px; size: 35; font-size: 35px;`
  ...
  NoteField2.style = `position:absolute; left: 350px; top: 500px;
   height: 35px; size: 35; font-size: 35px;`
  ...
  ShuffleButton.style = `position: absolute; left: 400px; top: 200px;
  ...
  DealButton.style = "position: absolute; left: 650px; top: 200px; font-size: 40px, text-align: center";
  ...
  for(let i = 1; i < 37; i++) { // creating future placements of user's cards
    ...
    lf.id = "lp"+i;
    lf.style = `position: absolute; left: ${leftPos}px; top: ${topPos}px;`
    topPos += 25;
  ...
  for(let i = 1; i < 37; i++) { // creating future placements of computers' cards
    ...
    rt.id = "rp"+i;
    rt.style = `position: absolute; left: ${leftPos}px; top: ${topPos}px;`
    topPos += 25;
    document.body.appendChild(rt);
  }
  leftPos = 930; // Hiding computer's cards
  topPos = 200;
  for(let i = 1; i < 37; i++) {
    if (i === 13) {
      leftPos = 1010;
    ...
    rtH.id = "rpH"+i;
    rtH.style = `position: absolute; left: ${leftPos}px; top: ${topPos}px;`
    topPos += 25;
    document.body.appendChild(rtH);
  }
  leftPos = 300; // creating future placements of attacking cards
  topPos = 300;
  for(let i = 1; i < 7; i++) {
    ...
    btUp.style = `position: absolute; left: ${leftPos}px; top: ${topPos}px`; //border: solid`;
    leftPos += 101;
    document.body.appendChild(btUp);
  }
  leftPos = 300; // creating future placements of defending cards
  topPos = 330;
  for(let i = 1; i < 7; i++) {
    ...
    btBt.style = `position: absolute; left: ${leftPos}px; top: ${topPos}px`; //border: solid`;
    leftPos += 101;
...
let deal = async function() {
  ...
  showTrumpCard.id = "TC";
  showTrumpCard.style = `position: absolute; left: 500px; top: 180px; border: solid`;
  document.body.appendChild(showTrumpCard);
  document.getElementById("mD").style =`position: absolute; left: 500px; top: 130px;
  ...
  PassButton.style = "position: absolute; left: 380px; top: 220px; font-size: 40px, text-align: center";
  ...
  TakeButton.style = "position: absolute; left: 380px; top: 260px; font-size: 40px, text-align: center";
...
let topUp1 = async function () { //topping up if computer fails to defend
  ...
  if (Object.keys(player1) == 0 && Object.keys(player2) == 0) {
    ...
    RestartButton.style = `position: absolute; left: 600px; top: 500px;
    font-size: 40px, text-align: center`;
